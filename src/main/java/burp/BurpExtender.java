        ...
        SwingUtilities.invokeLater(() -> {
            ...
            if(callbacks.loadExtensionSetting("matchReplaceTable") != null) {
                try {
                    ...
                    printException(e, "Error loading Table Value:"+ callbacks.loadExtensionSetting("matchReplaceTable"));
                }
            }
            ...
            JLabel title = new JLabel("Match、Replace And Set Var");
            ...
            checkbox_enable_match_repalce.addActionListener(e -> {
            ...
            checkbox_enable_match_repalce_repeater.addActionListener(e -> {
            ...
            checkbox_enable_match_repalce_EXTENDER.addActionListener(e -> {
...
//				burpyPath.setMaximumSize( burpyPath.getPreferredSize() );
            ...
            clearConsoleButton.addActionListener(e -> SwingUtilities.invokeLater(() -> {
